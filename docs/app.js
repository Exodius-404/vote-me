// Party Outfit Voting - Username-only frontend (single, cleaned file)
// Firebase configuration (use your project's values)
...
import { getFirestore, collection, addDoc, query, where, serverTimestamp, getDocs, updateDoc, doc, orderBy } from 'https://www.gstatic.com/firebasejs/12.12.0/firebase-firestore.js';
